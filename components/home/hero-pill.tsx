...
export function HeroPill({ verifiedCount, lastCheckedISO }: Props) {
  return (
    <div className="mb-5 inline-flex max-w-full items-center gap-2 rounded-full border border-stone-300 bg-white px-3 py-1 text-[11px] tracking-wide text-stone-600">
